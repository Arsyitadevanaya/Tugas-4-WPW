...
<html lang="en">
    ...
    <body>
        <?php
            ...
            $data= "SELECT * FROM mahasiswa WHERE nrp='$id'";
            $result=mysqli_query($conn, $data);
            $row= mysqli_fetch_assoc($result)
        ?>
            <div class="container">
            <br/>
            <h2 align="center">FORM UPDATE DATA MAHASISWA PENS</h2>
                <form method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nomor_hp" value="<?php echo $row['no_hp']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Asal SMA</label>
                        <input type="text" class="form-control" name="asal_sma" value="<?php echo $row['asal_sma']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Mata Kuliah Favorit</label>
                        <input type="text" class="form-control" name="matkulfav" value="<?php echo $row['matkul']; ?>">
                    </div>
            ...
            if(isset($_POST['submit'])){
                ...
                $sql="UPDATE mahasiswa SET nama='$nama', nrp='$nrp', jenis_kelamin='$jenis_kelamin', jurusan='$jurusan',email='$email', alamat='$alamat', no_hp='$nomor_hp', asal_sma='$asal_sma', matkul='$matkulfav' WHERE nrp='$id'";
